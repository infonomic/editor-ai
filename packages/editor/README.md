...
Load the editor via whatever field or component entry point your application uses.

### Component Hierarchy 

Once the editor has been 'bootstrapped', the editor field is rendered and managed via the following component hierarchy:
...
1. `pnpm add @infonomic/editor` or `npm install @infonomic/editor`

```ts
import { defaultEditorConfig } from '@infonomic/editor'
import { EditorField } from '@infonomic/editor'
```
